...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		// Proxy management (Clash proxy pool management)
		...
		proxyRoute.Use(middleware.AdminAuth())
		{
			...
			proxyRoute.POST("/refresh", controller.RefreshProxyNodes)
			proxyRoute.POST("/switch", controller.SwitchProxyNode)
			proxyRoute.POST("/test", controller.TestProxyNode)
			proxyRoute.POST("/clear-cooldown", controller.ClearProxyCooldown)
			// 订阅管理
			proxyRoute.GET("/subscribe", controller.GetSubscribeList)
			proxyRoute.PUT("/subscribe", controller.UpdateSubscribeList)
			proxyRoute.POST("/subscribe/download", controller.DownloadSubscribe)
			// 日志
			proxyRoute.GET("/logs", controller.GetMihomoLogs)
		}
	}
}
